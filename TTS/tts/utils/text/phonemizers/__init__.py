...
from TTS.tts.utils.text.phonemizers.vi_vn_phonemizer import VI_VN_Phonemizer
...
DEF_LANG_TO_PHONEMIZER["vi-vn"] = VI_VN_Phonemizer.name()
...
def get_phonemizer_by_name(name: str, **kwargs) -> BasePhonemizer:
    ...
    if name == "vi_vn_phonemizer":
        return VI_VN_Phonemizer(**kwargs)
